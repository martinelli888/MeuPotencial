...
public class Fragment5 extends Fragment {
    ...
    Comunicador5 comunicador;
    int valorEscolhido;

    public Fragment5() {
    }

    public interface Comunicador5 {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                valorEscolhido = mySeek.getProgress();
                comunicador.enviar(valorEscolhido, 4);
            }
        });
...
//monetização
        ...
        AdView adView = (AdView) v.findViewById(R.id.Propaganda_5);
    ...
    public void onAttach(Context context) {
        comunicador = (Comunicador5) context;
